...
public class TestSootLoggingHeap extends BodyTransformer {
	...
	public static void main(String[] args)	{
		...
		String mainclass = "project.HelloThread";
...
//		//set classpath
		...
		SootClass logClass = Scene.v().loadClassAndSupport("project.Log");
	...
	protected void internalTransform(Body b, String phaseName,
		...
		if(!b.getMethod().getDeclaringClass().getName().equals("project.Log"))
		{
		    ...
		    while(it.hasNext()){
		    	...
		    	if (stmt.containsFieldRef()) {
		    		...
		    		FieldRef heap = stmt.getFieldRef();
		    		String name = heap.getFieldRef().name(); 
		    		logFieldAcc(heap, name ,heap.getFieldRef().isStatic(),heap.getFieldRef().isStatic()); 
		    	}
		    }
		}
	}
